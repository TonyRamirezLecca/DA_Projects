...
defer(function () {
	jQuery(function () {        
		...
		whenExists('.maxbutton-12.maxbutton.maxbutton-national', function () {
			...
			jQuery('<p class="da_new-button">CALL US TODAY AT</br> <a href="tel:866-363-3351">866-363-3351</a> FOR A</br> CONSULTATION, OR</br></p>').insertBefore('#wi-content > .container:first-child .maxbutton-12.maxbutton.maxbutton-national');
