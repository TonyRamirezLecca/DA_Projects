...
whenExists("div[id$=\"-dims\"]", function () {
	setInterval(() => {
		...
		if (document.querySelector(".logoContainer")){ console.log("already there"); return;}
		...
		logoImg.src = "https://disruptive-advertising.s3-us-west-2.amazonaws.com/Wandrd/pdp-carry-on-emphasis/tsa-seal.png";
