...
/* ---------------------------------- */
	...
	jQuery('<div class="da_links"><a href="#shopify-section-how-it-work">How It Works</a><a href="#shopify-section-what-in-the-box">What\'s in the Box</a><a href="#shopify-section-review-section">See Reviews</a><a href="#shopify-section-app-section">Get Inspired</a></div>').insertAfter('.app-page-section.app-page-section-info');
