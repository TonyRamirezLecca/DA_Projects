...
defer(function () {
	jQuery(function () {        
		whenExists('.related-products-module .related-product-item:nth-child(3), .related-article-module, .node-title.block-ctools-block.block-label-title.block--problem-name', function () {
			...
			jQuery('<a class="da_link">In a hurry? Check out our top picks to get the job done.</a>').insertAfter('.node-title.block-ctools-block.block-label-title.block--problem-name')
			jQuery('.da_link').click(function() {
				event.preventDefault();
				if (window.innerWidth > 800) {
					jQuery([document.documentElement, document.body]).animate({
						scrollTop: jQuery('.da_ctn').offset().top - 60
					}, 600);
				}
				else {
					jQuery([document.documentElement, document.body]).animate({
