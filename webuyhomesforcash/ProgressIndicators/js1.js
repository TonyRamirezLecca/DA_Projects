...
whenExists('.back, .step:nth-child(13)', function () {
	...
	$('.step').each(function() {
		$('<div class="da_progress-bar"><div class="da_step da_current"></div><div class="da_line"></div><div class="da_step"></div><div class="da_line"></div><div class="da_step"></div><div class="da_line"></div><div class="da_step"></div><div class="da_line"></div><div class="da_step"></div><div class="da_line"></div><div class="da_step"></div><div class="da_line"></div><div class="da_step"></div><div class="da_line"></div><div class="da_step"></div><div class="da_line"></div><div class="da_step"></div><div class="da_line"></div><div class="da_step"></div><div class="da_line"></div><div class="da_step"></div><div class="da_line"></div><div class="da_step"></div><div class="da_line"></div><div class="da_step"></div></div>').insertAfter($(this).find('.Formtitle'));
	});
