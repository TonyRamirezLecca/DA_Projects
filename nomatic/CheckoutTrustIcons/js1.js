...
whenExists('#order-summary > div > div.order-summary__section.order-summary__section--total-lines, body > div.content > div > div.main', function () {
	...
	jQuery(`<div class="da_value-props-desktop"><img src="${imageURL}"/><p class="da_asteriks">Free Shipping only available for destinations in the continental US</p></div>`).insertAfter('#order-summary > div > div.order-summary__section.order-summary__section--total-lines');

	jQuery(`<div class="da_value-props-mobile"><img src="${imageURL}"/><p class="da_asteriks">Free Shipping only available for destinations in the continental US</p></div>`).insertAfter('body > div.content > div > div.main');
