...
if (window.location.href.includes('/cart')) {
	...
	defer(function () {
		jQuery(function () {        
			whenExists('#shopify-section-footer', function () {
				...
				if (country == "United States" && priceIsAbove50) {
					...
					jQuery(`<div class="da_value-props-mobile"><img src="${imageURL}"/><p class="da_asteriks">Free Shipping only available for destinations in the continental US</p></div>`).insertBefore('#shopify-section-footer');
				} 
				else {
