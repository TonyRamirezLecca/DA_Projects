...
var jq = setInterval(function(){
	if ( jQuery ) {
		...
		jQuery(function(){
			...
			//REMOVE PLACEHOLDERS
			jQuery('#input_11_1_3, #input_11_1_6, #input_11_3, #input_11_10, #input_11_2, #input_11_8').focus(function(){
			...
			jQuery('#input_11_15').focus(() => {
				jQuery('#input_11_15 > option.gf_placeholder').html('');
				jQuery('label[for="input_11_15"]').addClass('da_show-state');
			});
