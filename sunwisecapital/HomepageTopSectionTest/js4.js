...
document.querySelectorAll(".fourcol-one")[1].querySelector("img").src = "https://disruptive-advertising.s3-us-west-2.amazonaws.com/sun-wise-capital/HomepageTopSection/revenue.png";

jQuery("#scroll_to_section1").after('<iframe class="youtubeVid" width="560" height="315" src="https://www.youtube.com/embed/q_5q8R3IwdA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>');
}
