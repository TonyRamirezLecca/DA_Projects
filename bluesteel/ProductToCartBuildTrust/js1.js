...
if (window.location.href.includes('/cart')) {
	...
	ready('.cart-right', function(){
		var $ = jQuery;
		//ADD FONTAWESOME 5
		$('head').append('<script defer src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.12.1/js/all.min.js"><\/script>');
		//ADD CONTENT
		$('.cart-right').prepend('<div class=da-trust><div class=da-icons><div class=da-prop><i class="fas fa-sync-alt"></i><p>Free Exchanges</div><div class=da-prop><i class="fas fa-truck"></i><p>Free Shipping</div><div class=da-prop><i class="fas fa-award"></i><p>One-Year Warranty</div></div></div>');
	});
}
