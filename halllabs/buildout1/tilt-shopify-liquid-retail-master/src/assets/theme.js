...
theme.Product = (function() {
  function Product(container) {
    ...
    this.selectors = {
      ...
      comparePrice2: '#2ComparePrice-' + sectionId,
      originalPrice2: '#2ProductPrice-' + sectionId,
      SKU: '.variant-sku',
...
function openPopup(id) {
  ...
  backdrop = document.querySelector('#' + id + ' .popup-backdrop');
  backdrop.addEventListener('click', function(){
    closePopup(id);
  });

  document.getElementById(id).style.maxHeight = "2000px";
  scrollTo(document.body, document.getElementById(id).offsetTop, 100);
}
function closePopup(id){
  var backdrop = document.querySelector('#' + id + ' .popup-backdrop');
...
function toggle(id){
  ...
  var style = getComputedStyle(div).maxHeight;
  if (style !== '0px') {
...
/**============add <sup> to all Registered Trademark symbols =======**/
...
defer(function(){
    ...
    jQuery('#da-learn-more').click(function(){
      
        jQuery('#slickSlide00 > div.slideshow__text-wrap.slideshow__overlay > div > div > a').click();
